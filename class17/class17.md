class17:Metagenomics co-occurence networks
================
Negin Silani
5/28/2019
...
```
    ...
    ## IGRAPH 27f94e9 DNW- 4 4 -- 
    ## + attr: name (v/c), group (v/c), score (v/n), interaction (e/c),
    ## | weight (e/n)
    ## + edges from 27f94e9 (vertex names):
...
![](class17_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
```
    ...
    ## + 845/845 vertices, named, from 7ea48d3:
...
```
    ...
    ## + 1544/1544 edges from 7ea48d3 (vertex names):
